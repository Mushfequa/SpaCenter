#!/usr/bin/env node
/*
	NodeMVC project management system
...
console.log("NodeMVC version " + version);
...
try {
	if(argv["?"]) {
		...
		//	TODO: check this is a nodemvc project.
		console.log("Running project...");
		npm.load(pjson, function (err) {
			npm.commands.run(["rundev"], function(){
				console.log("NodeMVC run completed");
			});
		});
		...
		if(!fs.existsSync(projectPath)) {
			...
			fs.copySync(nodemvcPath, projectPath);
